...
$(function (){
    ...
    $.ajax({
        ...
        success:function (res) {
            ...
            //console.log(33);
             ...
             $("a",".mPpro_button",".mPbutton_frame","#merchantPro").attr({"href": "homepage3to3_PBL2.html?user=" + res.information.userName});
             //console.log('123555');
             //console.log(res);
    ...
    $(".mPchat_button", ".mPbutton_frame", "#merchantPro").click(function () {//newadd
        ...
        if(get_user!=null){
            ...
            window.open("../../shop/Chinese/userHomepage_chartLog_PBL2.html");
        }
    ...
    $("#doPost").click(function(){
        ...
        $.ajax({
            ...
            success:function (msg) {
                //console.log(msg);
                window.location.href="../../shop/Chinese/detail_PBL2.html?id="+item_id;
