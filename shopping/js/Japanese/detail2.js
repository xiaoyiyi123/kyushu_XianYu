var camp = {
  ...
  function getNowFormatDate() {
    ...
    var currentdate =
      year + "-" + month + "-" + strDate + " " + hour + ":" + min + ":" + second;
    return currentdate;
  }
  ...
  $(function () {
    ...
    $.ajax({
      ...
      success: function (res) {
        ...
        //console.log(res);
        //console.log(33);
        var picture="../../php/"+res.information.Picture;
        console.log(picture);
        $(".goodsName").text(res.information.Name);
        //$("#rmPrice").text(res.information.Price);
        $("#bigImg").attr({ src: picture});
        $("#newPrice").text(res.information.Price);
        ...
        $(".mPchat_button", ".mPbutton_frame", "#merchantPro").attr({
    ...
    $(".mPchat_button", ".mPbutton_frame", "#merchantPro").click(function () {
      //newadd
      var whose = this.id;
      if (get_user != null) {
        $.ajax({
    ...
    $(".minpic", "ul", ".smallImg", ".smallImg_bar").click(function () {
      var get_src = $("#" + this.id, "ul", ".smallImg", ".smallImg_bar").attr(
        "src"
      );
    ...
    //           "../../shop/Japanese/detail_PBL2_J.html?id=" + item_id;
    //       },
    //       error: function () {
    //         console.log("error!");
    //       },
