...
$(function (){
    ...
    document.getElementById('mobile').onkeyup=function (){
        var str=imobile.val();
        var reg=/^([A-Za-z0-9_\-\.])+$/;
        var temp1 ="<i class='fa fa-exclamation-circle iconfont mob-i mob-i01'>&#10003;</i>Entered correctly！"
        var temp2 ="<i class='fa fa-exclamation-circle iconfont mob-i mob-i02'>&#10007;</i>Entered error！"
        if(reg.test(str)){
            tishi.html(temp1);
    ...
    $("#mobileSubmitFirst").click(function (){
        ...
        if(mobile!=""&&vcode!=""&&vcode.value==vcodess.innerHTML&&$("#mobileAgreeClause").attr("checked") == "checked"){
            ...
            var stmp="code have been sent to <i class='usermobile01' style='color: #0000FF'>@s.kyushu-u.ac.jp"+mobile01+"</i>，Please finish in 1 min。"
            $("#mobilemsg").html(stmp);
        }
        else {
            alert("Please enter the correct username, password and capture！");
        }
    ...
    var tishi6=$(".yzm-i02")
    var tempa ="<i class='fa fa-exclamation-circle iconfont yzm-i02 mob-i01'>&#10003;</i>Captcha is correct！"
    var tempb ="<i class='fa fa-exclamation-circle iconfont  yzm-i02 mob-i02'>&#10007;</i>Captcha is wrong！"
    ...
    document.getElementById('memberName').onkeyup=function (){
        ...
        var temp1 ="<i class='fa fa-exclamation-circle iconfont uname-i mob-i01'>&#10003;</i>Username format is correct！"
        var temp2 = "<i class='fa fa-exclamation-circle iconfont uname-i mob-i02'>&#10007;</i>Please use 6-20 Chinese, English, numbers and " -" symbols, and not all numbers"
        if( reg1.test(str1)){
            tishi.html(temp1);
            tishi.css("display","block");
            tishi2.addClass("mob-i01")
    ...
    document.getElementById('mobileMemberPwd').onkeyup=function () {
        ...
        var temp1 ="<i class='fa fa-exclamation-circle iconfont upwd-i mob-i01'>&#10003;</i>Password format is correct！"
        var temp2 ="<i class='fa fa-exclamation-circle iconfont upwd-i mob-i02'>&#10007;</i>Password should be between 6-20 digits"
        if( reg2.test(str2)){
            tishi.html(temp1);
            tishi.css("display","block");
            tishi2.addClass("mob-i01")
    ...
    document.getElementById('mobileRepeatMemberPwd').onkeyup=function (){
        ...
        var tishi2=$(".rpwd-i");
        var temp1 ="<i class='fa fa-exclamation-circle iconfont rpwd-i mob-i01'>&#10003;</i>Password is correct！"
        var temp2 ="<i class='fa fa-exclamation-circle iconfont rpwd-i mob-i02'>&#10007;</i> Password is wrong！";
        //console.log(pwd);
        //console.log(rpwd);
        if(pwd.val() == rpwd.val()){
            console.log(pwd.val());
    ...
    $("#mobileSubmitSecond").click(function (){
        ...
        if(vcode2.value==str0&&pwd==rpwd){
            ...
            // 用户名 传送到 第三步
            var stmp = "Registration success! username:<i class='usermobile01' style='color: red'>" + username +"</i>，</br>Please<a href='login_E.html'>Login</a>"
