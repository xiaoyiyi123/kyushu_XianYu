...
$(document).ready(function(){
    ...
    $.ajax({
        ...
        success: function(msg){
            ...
            for(var i=0;i<8;i++){
                ...
                $("#history"+String(i+1)+"_a").attr({"href":"./detail_PBL2_E.html?id="+msg[i].Item_Id});
    ...
    $(".input-sub",".search-form",".search-top",".search").click(function(){
        ...
        window.open("../../shop/English/searchResult_PBL2_E.html");
    });
...
function PHPConnection(a,b){
    ...
    $.ajax({
        ...
        success: function(msg){
            ...
            $("#item1").attr({"href":"./detail_PBL2_E.html?id="+msg.Id1});
