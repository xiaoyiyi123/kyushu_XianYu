        ...
        success: function(msg){
            ...
            for(var i =0;i<msg.Sell_Num;i++){
                ...
                '<div class="h3li_detail">'+
                    '<div class="h3li_name">'+'<a href="detail_PBL2_E.html">'+msg.Sell[i].Name+'</a> '+'</div>'+
                    '<div class="h3li_status">Goods status:'+sold[msg.Sell[i].Status]+'</div>'+
                '</div>');
            }
        ...
        '<div class="h3rc_frame3">'+
            '<div class="h3l_itemframe" style="margin-left:90px;margin-top:5px;">'+
                ...
                '<div class="h3li_detail">'+
                    ...
                    '<div class="h3li_status">Goods status:'+sold[msg.Buy[j].Status]+'</div>'+
                '</div>'+
            '</div>'+
        '</div>'+
    '</div>');
